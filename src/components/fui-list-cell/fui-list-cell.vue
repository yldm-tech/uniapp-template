<!--本文件由FirstUI授权予杭州悦灵筑梦科技有限公司（手机号：18 2  6   71 48  20 6，身份证尾号：7YRU4J）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
  <view
  ...
  >
    <view
      v-if="topBorder"
      :style="{ background: getBorderColor, left: topLeft + 'rpx', right: topRight + 'rpx' }"
    ...
    <view
      ...
      :class="{ 'fui-cell__border-color': !getBorderColor }"
    ></view>
    <view class="fui-cell__arrow" v-if="arrow" :style="{ 'border-color': getArrowColor }"> </view>
  </view>
</template>
