    ...
    screenSizeSet(screen, classList) {
      if (typeof this[screen] === 'number' && this[screen] !== -1) {
        ...
        typeof this[screen].offset === 'number' &&
          classList.push('fui-col-' + screen + '-offset-' + this[screen].offset)
        typeof this[screen].pushLeft === 'number' &&
          classList.push('fui-col-' + screen + '-push-' + this[screen].pushLeft)
        typeof this[screen].pullRight === 'number' &&
          classList.push('fui-col-' + screen + '-pull-' + this[screen].pullRight)
