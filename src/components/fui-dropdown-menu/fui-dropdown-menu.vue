<!--本文件由FirstUI授权予杭州悦灵筑梦科技有限公司（手机号： 1    8 26   71482 06，身份证尾号：7YRU4J）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
            ...
            <view
              ...
              :class="{
                ...
                'fui-ddm__checkbox-color':
                  (!checkboxColor || checkboxColor === true) && model.checked && !isCheckMark,
              }"
              :style="{
                background: model.checked && !isCheckMark ? getChkColor : 'transparent',
                borderColor: model.checked && !isCheckMark ? getChkColor : borderColor,
              }"
              v-if="isCheckbox"
            >
              <view
