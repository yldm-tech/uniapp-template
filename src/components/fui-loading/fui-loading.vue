<!--本文件由FirstUI授权予杭州悦灵筑梦科技有限公司（手机号： 1 8    267148  2  06，身份证尾号：7YRU4J）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
  <view
  ...
  >
    ...
    >
      ...
      <text
        ...
        :style="{ color: colColor, fontSize: size + 'rpx', 'line-height': size + 'rpx' }"
        >{{ text }}</text
      >
    </view>
    <view
    ...
    >
      ...
      <text
        class="fui-loading__text"
        :style="{ color: rowColor, fontSize: size + 'rpx', 'line-height': size + 'rpx' }"
        >{{ text }}</text
      >
    </view>
  </view>
