<!--本文件由FirstUI授权予杭州悦灵筑梦科技有限公司（手机号：182 6 7 14   8 2  0 6，身份证尾号：7YRU4J）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
  <view
    @tap="maskClose"
  ...
  >
    ...
    >
      ...
      <view class="fui-dialog__body" :class="{ 'fui-dialog__mtop': !title }">
        <text class="fui-dialog__descr" :style="{ color: contentColor }" v-if="content">{{
          content
        }}</text>
        <slot></slot>
      </view>
